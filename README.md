...
The workflow computes the standard GitHub Pages URL from the repository owner and name, so it works for both user/organization pages and project pages without calling the Pages API during the build job.
